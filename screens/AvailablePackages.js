  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: Dimensions.get('screen').height * .01, height: Dimensions.get('screen').height*0.8, paddingBottom: Dimensions.get("screen").height * .12 }}>
          <FlatList
